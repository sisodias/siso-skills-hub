...
| websearch | Search the web using Perplexity Sonar via OpenRouter when the user requests web research or the task needs current external information. | bundled |
